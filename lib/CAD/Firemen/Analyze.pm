...
{
  $CAD::Firemen::Analyze::VERSION = '0.5.0';
}
use Exporter 'import';
...
Firemen::Change object as values.

# the keys of %{$added} and %{$removed} are line numbers of the second options
$added = {
  1 => "ADDED_OPTION_ONE",
  2 => "ADDED_OPTION_TWO",
};
...
# the keys of %{$removed} are line numbers of the second options
$removed = {
  4 => "REMOVED_OPTION_ONE",
  5 => "REMOVED_OPTION_TWO",
  6 => "REMOVED_OPTION_ONE"
};
